      ...
      <div class="row">
        ...
        <div class="col-lg-7 col-md-12">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
              <div class="ss_foot_sec">
                <h2 class="ss_foot_head">Compañia</h2>
                <ul>
                  <li>
                    <a href="about.html">
                      <i class="fas fa-circle"></i> Acerca de
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fas fa-circle"></i> Socios Comerciales
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fas fa-circle"></i> Terminos de uso
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fas fa-circle"></i> Politica de privacidad
                    </a>
                  </li>
                  <li>
                    <a href="#">
                      <i class="fas fa-circle"></i> Centro de ayuda
                    </a>
                  </li>
                </ul>
              </div>
